...
This is a basic template to get you started with the EmpDetails challenge.
...
At this point, you should see the placeholder EmpDetails app homepage.
...
word `EmpDetails` followed by your actual name, e.g. `EmpDetails-johnsmith`):
...
```
git remote add origin git@github.com:${your-github-username}/EmpDetails.git
